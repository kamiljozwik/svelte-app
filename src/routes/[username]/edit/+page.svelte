<script lang="ts">
	...
	// writable store for form data. Możemy tego użyć zamiast tworzyć oddzielne zmienne dla każdego pola formularza
	const formData = writable(formDefaults);

	let showForm = false;

	// $: is a reactive statement. It will run whenever any of the variables inside of it change
	// gdy bardziej skomplikowane to lepiej użyć svelte form library
